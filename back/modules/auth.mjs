...
const check_authentication = async (ctx, next) => {
    if (ctx.request.method == 'OPTIONS' || ctx.request.url == '' || ctx.request.url == '/api/cognito' || ctx.request.url == '/' || ctx.request.url.startsWith('/public') || ctx.request.url.startsWith('/index.html'))
        return await next();
